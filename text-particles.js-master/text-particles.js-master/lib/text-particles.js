...
function accelerate(opt) {
  ...
  options.textList = (opt.textList || "프로그래밍, 3D 디자인, AI 메이커, AR 메이커, 로보틱스, IoT 메이커, Game 메이커, APP 메이커, 데이타 분석").split(', '); // string: list of strings separated with a comma and a space
